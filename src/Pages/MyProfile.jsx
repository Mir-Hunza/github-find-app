...
const MyProfile = () => {
  ...
  useEffect(() => {
    const apiCall = setTimeout(() => {
      axios.get("https://api.github.com/users/Mir-Hunza").then((res) => setData(res.data));
      axios.get("https://api.github.com/users/Mir-Hunza/repos").then((res) => setRepos(res.data));
    }, 1500);
              ...
              <div className="card-body flex items-center p-0 sm:p-5">
                ...
                <div className="badges my-1 flex w-full justify-evenly flex-wrap">
                  <div className="badge badge-primary cursor-pointer ">
                    <a href="https://github.com/Mir-Hunza?tab=repositories">
                  ...
                  <div className="badge badge-accent cursor-pointer">
                    <a href="https://github.com/Mir-Hunza?tab=following">
